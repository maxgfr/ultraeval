...
const TRACKED = [
  // The analysis snapshot is codeindex walking the golden fixture: dependency
  // cycles, edges, docs. A newer engine sees more of the same repo, so this
  // moves on a bump and must not be a hard red.
  "tests/__snapshots__/analyze-golden.test.ts.snap",
];
