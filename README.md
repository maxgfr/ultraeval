...
These skills run when explicitly invoked: `ultraeval`. Use `$name` in Codex or `/name` in Claude Code and OpenCode (with the plugin namespace when installed as a Claude plugin).
